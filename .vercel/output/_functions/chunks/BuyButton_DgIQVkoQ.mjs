import { c as createComponent, m as maybeRenderHead, a as renderTemplate, b as createAstro, d as addAttribute, r as renderComponent } from './astro/server_DNz_VwZo.mjs';
...
}, "/Users/admin/Documents/Github/dev-books/src/components/AmazonLogo.astro", void 0);
...
const $$BuyButton = createComponent(($$result, $$props, $$slots) => {
  ...
  const title = `Comprar en Amazon ${countryName}`;
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(url, "href")}${addAttribute(title, "title")} target="_blank" rel="noopener noreferrer" class="text-balance inline-flex gap-2 items-center bg-yellow-400 
...
"> ${title} ${renderComponent($$result, "AmazonLogo", $$AmazonLogo, {})} </a>`;
}, "/Users/admin/Documents/Github/dev-books/src/components/BuyButton.astro", void 0);

const $$file = "/Users/admin/Documents/Github/dev-books/src/components/BuyButton.astro";
const $$url = undefined;
